      ...
      <div class="col-12">
        <nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid px-0">
            <a class="navbar-brand font-weight-bolder ms-sm-3 d-none d-md-block" href="" rel="tooltip" title="Designed and Coded Thapelo" data-placement="bottom" target="_blank">
              Laravel Course
            </a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 mt-8 position-relative z-index-1">
            ...
            <h1>Laravel Learning Web</h1>
            <p class="text-lg mt-3">
            Laravel is a web application framework with expressive, elegant syntax. 
            Laravel has already laid the foundation — freeing you to create without sweating the small things.
            </p>
      ...
      <div class="container my-8">
        <div class="row mb-5">
          <div class="col-lg-6 mx-auto text-center">
            <h2>Chat with the Developer</h2>
            <p class="text-secondary lead font-weight-normal pe-3">For any questions, comments, collaboration etc. chat to our developer.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-md-6 ms-auto">
            <div class="p-3">
              <a href="https://github.com/austinmokoena" target="_blank" class="icon icon-shape icon-md text-center bg-gradient-dark shadow-dark">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="p-3">
              <a href="https://x.com/taustinmokoena" target="_blank" class="icon icon-shape icon-md text-center bg-gradient-dark shadow-dark">
              <i class="fab fa-twitter opacity-10"></i>  
            </a>
              <h5 class="mt-4">Twitter/X</h5>
              <p>For feature requests and contribute.</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 me-auto">
            <div class="p-3">
              <a href="https://wa.me/+27715538227" target="_blank" class="icon icon-shape icon-md text-center bg-gradient-dark shadow-dark">
              <i class="fab fa-whatsapp opacity-10"></i>
              </a>
              <h5 class="mt-4">Whatsapp</h5>
              <p>For issues and urgent matters.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-5 me-lg-auto my-lg-auto text-lg-end mt-5">
            <a href="https://twitter.com/intent/tweet?text=Check%20Material%20Dashboard%20made%20by%20%40CreativeTim%20%23webdesign%20%23designsystem%20%23bootstrap5&url=https%3A%2F%2Fwww.lavalite.co.za%2Fproduct%2Fmaterial-dashboard" class="btn btn-twitter mb-0 me-2" target="_blank">
              <i class="fab fa-twitter me-1"></i> Tweet
            </a>
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.lavalite.co.za/product/material-dashboard" class="btn btn-facebook mb-0 me-2" target="_blank">
              <i class="fab fa-facebook-square me-1"></i> Share
            </a>
            <a href="https://www.pinterest.com/pin/create/button/?url=https://www.lavalite.co.za/product/material-dashboard" class="btn btn-pinterest mb-0 me-2" target="_blank">
    ...
    <div class="container">
      <div class=" row">
        <div class="col-md-3 mb-4 ms-auto">
          <div>
            <a href="https://www.lavalite.co.za/product/material-dashboard">
        ...
        <div class="col-md-2 col-sm-6 col-6 mb-4">
          <div>
            ...
            <ul class="flex-column ms-n3 nav">
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/presentation" target="_blank">
                  About Us
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/templates/free" target="_blank">
                  Freebies
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/templates/premium" target="_blank">
                  Premium Tools
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/blog" target="_blank">
                  Blog
                </a>
              </li>
            </ul>
        ...
        <div class="col-md-2 col-sm-6 col-6 mb-4">
          <div>
            ...
            <ul class="flex-column ms-n3 nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/bits" target="_blank">
                  Bits & Snippets
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/affiliates/new" target="_blank">
                  Affiliate Program
                </a>
              </li>
            </ul>
        ...
        <div class="col-md-2 col-sm-6 col-6 mb-4">
          <div>
            ...
            <ul class="flex-column ms-n3 nav">
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/contact-us" target="_blank">
                  Contact Us
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/knowledge-center" target="_blank">
                  Knowledge Center
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://services.lavalite.co.za/?ref=ct-md2-footer" target="_blank">
                  Custom Development
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/sponsorships" target="_blank">
                  Sponsorships
                </a>
              </li>
            </ul>
        ...
        <div class="col-md-2 col-sm-6 col-6 mb-4 me-auto">
          <div>
            ...
            <ul class="flex-column ms-n3 nav">
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/knowledge-center/terms-of-service" target="_blank">
                  Terms & Conditions
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/knowledge-center/privacy-policy" target="_blank">
                  Privacy Policy
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.lavalite.co.za/license" target="_blank">
                  Licenses (EULA)
                </a>
              </li>
            </ul>
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="text-dark my-4 text-sm font-weight-normal">
              ...
              </script> Material Kit by <a href="https://www.lavalite.co.za" target="_blank">Lavalite Tech</a>.
            </p>
          </div>
        </div>
      </div>
