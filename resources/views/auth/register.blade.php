              ...
              <div class="card-body">
                <form role="form" class="text-start" method="POST" action="{{ route('register') }}">
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" id="name" name="name" class="form-control" required :value="old('name')" required autofocus autocomplete="name" placeholder="Full names">
                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                  </div>
                  <div class="input-group input-group-outline my-3">
                    {{-- <label class="form-label">Email</label> --}}
                    <input type="email" id="email" name="email" class="form-control" required :value="old('email')" required autofocus autocomplete="username" placeholder="Email address">
