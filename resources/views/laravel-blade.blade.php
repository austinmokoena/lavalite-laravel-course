...
<x-code-snippet language="php" :code="$phpCode1" />
        ...
        <ul>
            <li>Syntax is cleaner and more readable compared to plain PHP.</li>
            <li>Blade templates are compiled into plain PHP code, making them fast.</li>
        </ul>
        <h4>2. Blade Syntax and Directives</h4>
        <p>Blade provides an easy-to-use syntax to embed PHP in your views.</p>

        <p><b>a.</b> Displaying Variables</p>
        <p>To display variables, use double curly braces:</p>
